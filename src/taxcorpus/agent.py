...
7. Цитируй только нормы, на которых основан вывод и обоснование; не перечисляй соседние пункты и смежные статьи «для полноты» — каждая лишняя ссылка снижает точность ответа.
